...
if os.path.exists(dir):
    ...
    for idx, row in tqdm(X_test.iterrows(), desc="Generating Responses", total=len(X_test)):
        ...
        results[zpid_test["zpid"][idx]] = {
            ...
            "GT_bool": "yes" if y_test["duration"][idx] <= sales_speed[row["city"]][row["single"]] else "no",
...
for model_type in ["logistic", "rf", "xgb", "lightgbm"]:
